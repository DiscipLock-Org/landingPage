        ...
        <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 20px; color: #4b5563; font-size: 16px; line-height: 1.6;">
                You've signed up for <strong>${deviceType === 'ios' ? 'iOS' : 'Android'}</strong> notifications. We'll let you know as soon as the app is available for your device.
              </p>
              
              <div style="background-color: #eff6ff; border-left: 4px solid #2563eb; padding: 20px; margin: 30px 0; border-radius: 4px;">
                <h3 style="margin: 0 0 10px; color: #1e40af; font-size: 18px; font-weight: bold;">
                  What to Expect
                </h3>
              ...
              <p style="margin: 30px 0 20px; color: #4b5563; font-size: 16px; line-height: 1.6;">
                <strong>What is Disciplock?</strong><br>
          ...
          <tr>
            <td style="padding: 30px 40px; background-color: #f9fafb; border-radius: 0 0 12px 12px; border-top: 1px solid #e5e7eb;">
              ...
              <p style="margin: 10px 0 0; color: #9ca3af; font-size: 12px; text-align: center;">
                ...
                <a href="#" style="color: #2563eb; text-decoration: underline;">unsubscribe here</a>.
              </p>
            </td>
          </tr>
        </table>
