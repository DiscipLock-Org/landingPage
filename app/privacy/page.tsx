      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-100 mb-4">1. Introduction</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-100 mb-4">2. Information We Collect</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-100 mb-4">3. How We Use Your Information</h2>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-100 mb-4">5. Email Communications</h2>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-100 mb-4">6. Information Sharing and Disclosure</h2>
            <p className="text-gray-300 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-100 mb-4">7. Your Rights and Choices</h2>
            <p className="text-gray-300 mb-4">
            ...
            <p className="text-gray-300">
              To exercise these rights, please contact us at <a href="mailto:support@disciplock.app" className="text-blue-400 hover:text-blue-300 underline">support@disciplock.app</a>.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-100 mb-4">8. Children&apos;s Privacy</h2>
            <p className="text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-100 mb-4">9. International Data Transfers</h2>
            <p className="text-gray-300">
